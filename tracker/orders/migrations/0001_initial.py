    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('garage', models.CharField(blank=True, default='n/a', help_text='only for footings', max_length=3, null=True, verbose_name='Garage Height')),
                ('wea', models.CharField(blank=True, default='n/a', help_text='only for footings', max_length=50, null=True, verbose_name='Walkout Egress Area')),
            ],
            options={
