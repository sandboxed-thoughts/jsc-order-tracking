    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=8,
                        verbose_name="Pour Type",
                    ),
                ),
                (
                    "pdate",
                    models.DateField(blank=True, null=True, verbose_name="Pour Date"),
                ),
                (
                    "incw",
                    models.CharField(
                        choices=[("rain", "rain"), ("snow", "snow"), ("none", "none")],
                        default="none",
                        max_length=4,
                        verbose_name="Inclimate Weather",
                    ),
                ),
                (
                    "temp",
                    models.CharField(
                        choices=[("low", "low"), ("high", "high"), ("none", "average")],
                        default="none",
                        max_length=4,
                ...
                (
                    "lot",
                    models.CharField(
                        help_text="separate each lot with a comma (,)",
                        max_length=100,
                        verbose_name="Lot Numbers",
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Actual Total"
                    ),
                ),
                (
                    "ctype",
                    models.CharField(
                        choices=[("mix", "mix"), ("slmp", "slmp")],
                        max_length=4,
                        verbose_name="Mix/Slump",
                    ),
                ),
                ...
                (
                    "ctime",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Concrete Time"
                    ),
                ),
                (
                    "pprog",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=50,
                        null=True,
                        verbose_name="Walkout Egress Area",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "r_loads",
                    models.PositiveIntegerField(verbose_name="Loads Requested"),
                ),
                (
                    "d_loads",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Loads Delivered"
                    ),
                ),
                ...
                (
                    "driver",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="Driver"
                    ),
                ),
