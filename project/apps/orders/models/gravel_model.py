...
class Gravel(BaseOrder):
    ...
    Fields:
        ...
        ddate:          models.DateField(
                            _("Delivery / Pour Date"), auto_now=False, auto_now_add=False, blank=True, null=True
                        )
        supplier:       models.ForeignKey(
                            "suppliers.Supplier", verbose_name="supplier", related_name="gravel_orders", on_delete=models.CASCADE
                        )
        stype:          models.ForeignKey(
                            "suppliers.StoneType", verbose_name="stone type", related_name="orders", on_delete=models.CASCADE
                        )
