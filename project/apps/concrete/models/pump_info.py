...
from ..helpers import TempDelay, PrecipDelay, PourProgress
...
class PumpInfo(models.Model):
    ...
    temp = models.CharField(_("temperature"), max_length=4, blank=True, null=True, choices=TempDelay.choices, default=TempDelay.NONE)
    precip = models.CharField(_("inclimate weather"), max_length=5, blank=True, null=True, choices=PrecipDelay.choices, default=PrecipDelay.CLEAR)
