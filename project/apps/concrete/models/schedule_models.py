...
class PumpSchedule(models.Model):
    ...
    project_manager = models.ForeignKey(User, verbose_name=_("project manager"), related_name="pm_pump_schedule", on_delete=models.CASCADE)
    driver = models.ForeignKey(User, verbose_name=_("operator"), related_name="driver_pump_schedule", on_delete=models.CASCADE)
    ...
    progress = models.CharField(_("pump progress"), choices=PourProgress.choices, default=PourProgress.WILL_CALL, max_length=11)
    history = HR()
...
class ScheduleNotes(NoteModel):
    ...
    pump = models.ForeignKey("PumpSchedule", verbose_name=_("pump scheduled"), related_name="pump_notes", on_delete=models.CASCADE)
...
class WeatherNotes(NoteModel):
    ...
    weather = models.ForeignKey("InclimateWeather", verbose_name=_("weather note"), related_name="weather_notes", on_delete=models.CASCADE)
