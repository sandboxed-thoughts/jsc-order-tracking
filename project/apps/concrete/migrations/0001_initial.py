    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctype', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='suppliers.concretetype', verbose_name='concrete type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('ctype', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='suppliers.concretetype', verbose_name='concrete type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('notemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='core.notemodel')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='concrete_order_notes', to='concrete.concreteorder', verbose_name='concrete order notes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('concrete_order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pour_lots', to='concrete.concreteorder', verbose_name='concrete order')),
                ('lot', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='concrete_orders', to='clients.lot', verbose_name='lot')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='items',
            field=models.ManyToManyField(through='concrete.FlatworkOrderItems', to='concrete.flatworkitem', verbose_name='flatwork items'),
        ),
        migrations.AddField(
            model_name='concreteorder',
            name='lots',
            field=models.ManyToManyField(through='concrete.ConcreteOrderLot', to='clients.lot', verbose_name='lots'),
        ),
        migrations.AddField(
            model_name='concreteorder',
            name='supplier',
