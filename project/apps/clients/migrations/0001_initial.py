    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('builder', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='builder_lots', to='clients.builder', verbose_name='builder')),
